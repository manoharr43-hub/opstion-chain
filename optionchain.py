...
HYBRID NSE PRO SCANNER V11.1 — తెలుగు వివరణ
ఈ కోడ్ ఒక అడ్వాన్స్‌డ్ NSE స్టాక్ స్కానర్. ఇది Streamlit ద్వారా వెబ్ డాష్‌బోర్డ్ రూపంలో పని చేస్తుంది. ఇందులో టెక్నికల్ ఇండికేటర్లు, Smart Money Concepts (BOS/CHOCH), మరియు XGBoost Machine Learning AI కలిపి స్టాక్ సిగ్నల్స్ ఇస్తాయి.

1. ప్రధాన ఫీచర్లు
EMA Trend Analysis — 20 EMA మరియు 50 EMA ఆధారంగా ట్రెండ్‌ను గుర్తిస్తుంది.

RSI (Relative Strength Index) — స్టాక్ Overbought / Oversold లో ఉందో చెబుతుంది.

MACD Analysis — Momentum ను గుర్తిస్తుంది.

Supertrend Indicator — ట్రెండ్ UP లేదా DOWN అని చూపిస్తుంది.

VWAP (Volume Weighted Average Price) — ప్రైస్ VWAP పై ఉందా కింద ఉందా చెబుతుంది.

Breakout Detection — 20 రోజుల హై / లో ను బ్రేక్ చేసిందా అని చెక్ చేస్తుంది.

Smart Money Concepts (SMC) — BOS (Break of Structure) మరియు CHOCH (Change of Character) ను గుర్తిస్తుంది.

XGBoost AI Prediction Engine — తదుపరి కాండిల్ bullish లేదా bearish అయ్యే అవకాశాన్ని అంచనా వేస్తుంది.

Relative Strength vs NIFTY — స్టాక్ NIFTY కంటే మెరుగ్గా ఉందా లేదో చూపిస్తుంది.

Dynamic Target & Stoploss — ATR ఆధారంగా ఆటోమేటిక్ టార్గెట్ మరియు స్టాప్‌లాస్ ఇస్తుంది.

2. సైడ్‌బార్ సెట్టింగ్స్
Auto Refresh — ప్రతి 3 నిమిషాలకు డేటా రిఫ్రెష్ అవుతుంది.

Interval — 5m, 15m, 30m, 1h, 1d వంటి టైమ్‌ఫ్రేమ్‌లు.

Period — 5 రోజులు నుండి 1 సంవత్సరం వరకు డేటా ఎంపిక.

Sector Filter — Banking, IT, Pharma, Energy, Auto, FMCG వంటి సెక్టర్లను మాత్రమే స్కాన్ చేయవచ్చు.

3. Smart Money Concepts (BOS / CHOCH)
BOS (Break of Structure)
ప్రైస్ గత స్వింగ్ హై ను దాటితే BOS 📈 అని చూపిస్తుంది.

ఇది బలమైన బుల్లిష్ ట్రెండ్ కొనసాగుతున్న సంకేతం.

ప్రైస్ గత స్వింగ్ లో ను బ్రేక్ చేస్తే BOS 📉 చూపిస్తుంది.

CHOCH (Change of Character)
ట్రెండ్ మార్పు ప్రారంభమైనప్పుడు CHOCH 🔄 చూపిస్తుంది.

ఉదాహరణకు, డౌన్‌ట్రెండ్‌లో ఉన్న స్టాక్ అకస్మాత్తుగా హై బ్రేక్ చేస్తే బుల్లిష్ CHOCH గా పరిగణిస్తుంది.

4. XGBoost AI ఎలా పనిచేస్తుంది?
AI మోడల్ ఈ ఫీచర్లను ఉపయోగిస్తుంది:

రోజువారీ రిటర్న్స్ (Return)

RSI Normalized Value

Volume Ratio (ప్రస్తుత వాల్యూం vs సగటు వాల్యూం)

EMA20 మరియు EMA50 మధ్య గ్యాప్

ఈ డేటాతో XGBoostClassifier ట్రైనింగ్ చేసి తదుపరి కాండిల్ దిశను అంచనా వేస్తుంది.

ఉదాహరణ:

BULLISH 🚀 (78%) → తదుపరి కాండిల్ పైకి వెళ్లే అవకాశము 78%.

BEARISH 🔻 (65%) → దిగే అవకాశము 65%.

5. స్కోరింగ్ సిస్టమ్
ప్రతి ఇండికేటర్‌కు పాయింట్లు ఇస్తుంది:
...
తర్వాత మొత్తం స్కోర్ ఆధారంగా సిగ్నల్ ఇస్తుంది:
...
STRONG SELL
6. డాష్‌బోర్డ్‌లో కనిపించే ముఖ్యమైన కాలమ్స్
కాలమ్
...
AI సూచించిన టార్గెట్

Stoploss

సురక్షిత స్టాప్‌లాస్ స్థాయి

SMC Structure

BOS లేదా CHOCH సమాచారం
...
NIFTYతో పోలిస్తే బలం

Pattern

Candlestick Pattern (Hammer, Engulfing మొదలైనవి)

Signal

చివరి ట్రేడింగ్ నిర్ణయం

7. ఈ కోడ్ ప్రత్యేకత ఏమిటి?
సాధారణ EMA స్కానర్ కాదు.

Institutional Trading Concepts (SMC) ను ఉపయోగిస్తుంది.

Machine Learning (XGBoost) ను రియల్‌టైమ్ టెక్నికల్ డేటాతో కలుపుతుంది.

Target, Stoploss, Relative Strength, Multi-Timeframe Trend వంటి వివరాలను ఒకే డాష్‌బోర్డ్‌లో చూపిస్తుంది.

NSE500 స్టాక్స్‌ను ఒకేసారి స్కాన్ చేయగలదు.

ముఖ్యమైన గమనిక
ఈ స్కానర్ టెక్నికల్ మరియు AI ఆధారిత సూచనలు మాత్రమే ఇస్తుంది. నిజమైన ట్రేడింగ్ ముందు మార్కెట్ పరిస్థితులు, రిస్క్ మేనేజ్‌మెంట్, మరియు వ్యక్తిగత విశ్లేషణను తప్పనిసరిగా పరిగణించాలి.

మీకు కావాలంటే, నేను ఈ V11.1 కోడ్‌ను ఇంకా మెరుగుపరచడానికి (ఉదా: Option Chain Analysis, FII/DII Data, Telegram Alerts, Backtesting, AI Accuracy Report) ఎలా జోడించాలో కూడా వివరించగలను.
